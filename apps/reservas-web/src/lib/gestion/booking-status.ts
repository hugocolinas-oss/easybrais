...
export const STATUS_MAP: Record<string, StatusConfig> = {
  pending:          { label: "Pendiente de confirmación", shortLabel: "Pendiente",       bg: "bg-amber-100",   text: "text-amber-800",   dot: "bg-amber-500" },
  pending_payment:  { label: "Pendiente de pago",         shortLabel: "Pago pendiente",  bg: "bg-orange-100",  text: "text-orange-800",  dot: "bg-orange-500" },
  ...
  payment_expired:  { label: "Pago expirado",              shortLabel: "Pago expirado",   bg: "bg-gray-100",    text: "text-gray-600",    dot: "bg-gray-500" },
