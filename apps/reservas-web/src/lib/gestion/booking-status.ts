...
export const STATUS_MAP: Record<string, StatusConfig> = {
  ...
  pending_payment:  { label: "Confirmada",                shortLabel: "Confirmada",      bg: "bg-blue-100",    text: "text-blue-800",    dot: "bg-blue-500" },
  ...
  payment_expired:  { label: "Confirmada",                 shortLabel: "Confirmada",      bg: "bg-blue-100",    text: "text-blue-800",    dot: "bg-blue-500" },
