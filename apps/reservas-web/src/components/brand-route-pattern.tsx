...
export function BrandRoutePattern({
  className = "",
  fit = "slice",
  motifs = true,
  tone = "light",
}: BrandRoutePatternProps) {
  ...
  return (
    <svg
      ...
      fill="none"
      preserveAspectRatio={fit === "stretch" ? "none" : "xMidYMid slice"}
    ...
    >
      <g stroke={contour} strokeLinecap="round" strokeWidth="1.25" opacity={tone === "dark" ? 0.13 : 0.1}>
        ...
        <path d="M381 3c29 17 56 16 88-1M596 139c34-19 67-20 101-3M962 4c25 14 50 13 77-2" />
      </g>

      <path
        d="M-10 74C78 16 135 124 224 70s143-7 218 13 130-64 211-19 137 50 224-3 151 56 333-8"
        stroke={route}
        strokeDasharray="5 8"
        strokeLinecap="round"
        strokeWidth="2"
        opacity={tone === "dark" ? 0.42 : 0.34}
      />
        ...
        <>
          <g stroke={accent} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" opacity={tone === "dark" ? 0.76 : 0.68}>
            <g transform="translate(121 31)">
              <path d="M11 28s-8-8-8-16a8 8 0 0 1 16 0c0 8-8 16-8 16Z" />
              <circle cx="11" cy="12" r="2.5" />
            </g>
            <g transform="translate(345 44)">
              <path d="M12 30V14M12 30 4 14M12 30 20 14M12 30 1 20M12 30l11-10M12 30 5 25M12 30l7-5" />
              <path d="M1 20c1-9 5-14 11-18 6 4 10 9 11 18" />
            </g>
            <g transform="translate(700 24)">
              <path d="M11 28s-8-8-8-16a8 8 0 0 1 16 0c0 8-8 16-8 16Z" />
              <circle cx="11" cy="12" r="2.5" />
            </g>
            <g transform="translate(1084 56)">
              <path d="M12 30V14M12 30 4 14M12 30 20 14M12 30 1 20M12 30l11-10M12 30 5 25M12 30l7-5" />
              <path d="M1 20c1-9 5-14 11-18 6 4 10 9 11 18" />
            </g>
          </g>
          ...
          <g stroke={route} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" opacity={tone === "dark" ? 0.58 : 0.48}>
            <path d="m270 55-9 4 9 4M261 59h18" />
            <path d="m898 49 9 4-9 4M907 53h-18" />
            <g transform="translate(522 56)">
              <rect x="2" y="6" width="22" height="24" rx="5" />
              <path d="M8 6V4c0-3 10-3 10 0v2M8 14h10M7 30v3m12-3v3M2 19h22" />
              <path d="M9 24c3-4 7-4 10 0" stroke={accent} />
            </g>
          </g>
        </>
      ) : null}
