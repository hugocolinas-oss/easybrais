...
import { StatusBadge } from "@/components/reservas/status-badge";
import { StatusSelect } from "@/components/reservas/status-select";
import { NotesEditor } from "@/components/reservas/notes-editor";
import { EventTimeline } from "@/components/reservas/event-timeline";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        <Link href="/reservas" className="rounded-md border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-500 active:bg-gray-100 sm:hover:bg-gray-50">
          ← Reservas
        </Link>
